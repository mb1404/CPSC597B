      ...
      <div class="row-fluid">
        <div class="span3">
          ...
          <div class="well sidebar-nav">
            <ul class="nav nav-list">
              ...
              <li class="active"><a href="./frontPage">Manage Table</a>
                <ul class="nav nav-list">
                    %if tablesList:
        ...
        <div class="span9">
          <div class="hero-unit" style="background:#eeeeee;padding: 10px;">
            <center><h2><span style="color:blue;">{{choosenDB}}</span> - Manage Table</h2></center>
            </div>
          <div class="row-fluid">
            <div class="span12">
              
                 <p>Please choose a table from the left</p>
