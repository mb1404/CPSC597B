      ...
      <div class="row-fluid">
        <div class="span3">
          ...
          <div class="well sidebar-nav">
            <ul class="nav nav-list">
              ...
              <li class="active"><a href="/uploadDB">Upload Database</a></li>
            </ul>
          </div><!--/.well -->
        </div>
        ...
        <div class="span9">
          <div class="hero-unit" style="background:#eeeeee;padding: 10px;">
            <center><h2>Upload Database</h2></center>
            </div>
          <div class="row-fluid">
            <div class="span12">
                                  

                    <form action="/uploadDB2" method="post" enctype="multipart/form-data">
                        <div onclick="changeText()"> Choose Database: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                         <input type="file" name="data" /> </div>
                        <br><br>
                        <button type="submit" class="btn" name = "upload_db_btn" value="upload">Upload</button>
                    </form>
                    
                    %if "start" in message:
                        <p id="message"></p>
                    %elif "done" in message:
                        <p id="message" style="color:green;">The database was uploaded successfully</p>
                    %else:
