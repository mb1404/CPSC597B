      ...
      <div class="row-fluid">
        ...
        <div class="span9">
          <div class="hero-unit" style="background:#eeeeee;padding: 10px;">
            <center><h2>Create New Database</h2></center>
            </div>
          <div class="row-fluid">
            <div class="span12">
                  ...
                  <form class="form-inline">
                   New Database Name:
                  <input type="text" class="input-medium" name="databaseName">
                  <br><br>
                  <button type="submit" class="btn" name = "create_db_btn" value="create">Create</button>
                </form>
