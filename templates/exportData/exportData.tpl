      ...
      <div class="row-fluid">
        <div class="span3">
          ...
          <div class="well sidebar-nav">
            <ul class="nav nav-list">
              ...
              <li class="active"><a href="/database/{{choosenDB}}/exportData">Export Data</a></li>
        ...
        <div class="span9">
          <div class="hero-unit" style="background:#eeeeee;padding: 10px;">
            <center><h2>Export Data</h2></center>
            </div>
          <div class="row-fluid">
            <div class="span12">
               ...
               <table class="table">
                 ...
                 <tbody>
                    %for name in tablesList:
                        <tr>
                            <td>{{name}}</td>
                            <td><a class="btn" href="exportData/{{name}}.csv"> <i class="icon-download-alt"></i></a></td>
                        </tr>
                    %end
                  </tbody>
