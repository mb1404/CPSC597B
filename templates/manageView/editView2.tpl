        ...
        <div class="span3">
          ...
          <div class="well sidebar-nav">
            <ul class="nav nav-list">
              ...
              <li class="active"><a href="/database/{{choosenDB}}/manageView">Manage View</a></li>
        ...
        <div class="span9">
          ...
          <div class="row-fluid">
            <div class="span12">
                ...
                <form action="/database/{{choosenDB}}/editView2/{{viewName}}" name="editViewForm" class="form-inline">
                    <textarea rows="10" class="span10" name="updatedSQLStat">{{sqlStat}}</textarea><br><br>
                    <button type="submit" class="btn" name = "update_view_btn" value="update">Update View</button>
                ...
                % elif "done" in message:
                    <p style="color:green;">The view was updated successfully</p>  
                %else:
