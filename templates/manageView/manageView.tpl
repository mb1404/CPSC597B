      ...
      <div class="row-fluid">
        ...
        <div class="span9">
          <div class="hero-unit" style="background:#eeeeee;padding: 10px;">
            <center><h2>Manage View</h2></center>
            </div>
          <div class="row-fluid">
            <div class="span12">
                ...
                <table class="table">
                 ...
                 <tbody>
                     %for name in viewNames:
                        <tr>
                            <td>{{name[0]}}</td>
                            <td><a class="btn" href="/database/{{choosenDB}}/editView/{{name[0]}}"> <i class="icon-edit"></i></a></td>
                            <td><a class="btn" href="?dropView={{name[0]}}"> <i class="icon-trash"></i></a></td>
                        </tr>
                     %end
                  </tbody>
                </table>
