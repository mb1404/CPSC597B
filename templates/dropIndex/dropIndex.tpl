      ...
      <div class="row-fluid">
        <div class="span3">
          ...
          <div class="well sidebar-nav">
            <ul class="nav nav-list">
              ...
              <li class="active"><a href="/database/{{choosenDB}}/dropIndex">Drop Index</a></li>
        ...
        <div class="span9">
          <div class="hero-unit" style="background:#eeeeee;padding: 10px;">
            <center><h2>Drop Index</h2></center>
            </div>
          <div class="row-fluid">
            <div class="span12">
                ...
                <table class="table">
                 ...
                 <tbody>
                     %for indRow in indInfo:
                        <tr>
                            <td>{{indRow[0]}}</td>
                            <td>{{indRow[1]}}</td>
                            <td>{{",".join(indRow[2])}}</td>
                            <td><a class="btn" href="?dropIndex={{indRow[0]}}"> <i class="icon-trash"></i></a></td>
                        </tr>
                     %end
                  </tbody>
                </table>
