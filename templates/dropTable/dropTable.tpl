      ...
      <div class="row-fluid">
        <div class="span3">
          ...
          <div class="well sidebar-nav">
            <ul class="nav nav-list">
              ...
              <li class="active"><a href="/database/{{choosenDB}}/dropTable">Drop Table</a></li>
        ...
        <div class="span9">
          <div class="hero-unit" style="background:#eeeeee;padding: 10px;">
            <center><h2><span style="color:blue;">{{choosenDB}}</span> - Drop Table </h2></center>
            </div>
          <div class="row-fluid">
            <div class="span12">
                ...
                <form class="form-inline">
                 ...
                 <select name="tableName" class="input-medium" >
                     %for tableN in tablesList:
                          <option>{{tableN}}</option>
                     %end
                </select>
                <br><br>
                  <button type="submit" class="btn" name = "drop_table_btn" value="Drop">Drop</button>
                </form>              
            </div><!--/span-->
          </div><!--/row-->
        </div><!--/span-->
