      ...
      <div class="row-fluid">
        <div class="span3">
          ...
          <div class="well sidebar-nav">
            <ul class="nav nav-list">
              ...
              <li class="active"><a href="/database/{{choosenDB}}/SQLQuery">SQL query</a></li>
        ...
        <div class="span9">
          <div class="hero-unit" style="background:#eeeeee;padding: 10px;">
            <center><h2><span style="color:blue;">{{choosenDB}}</span> - SQL Query</h2></center>
            </div>
          <div class="row-fluid">
            <div class="span12">
              
              <form name="SQLQueryform" class="form-inline">
                  
                <textarea rows="10" class="span10" name="query">{{query}}</textarea>
                
                <br><br>
                <a href=""><button class="btn" name="submit" value="submit">submit</button></a>
                <br><br>
                ...
                %if message == "start":
                 <p>Please Enter SQL Query</p>
                %elif message == "done":
                 <p style="color:green">The query was executed succesfully</p>  
                %elif isinstance(message,list):
                    <table class="table">
                      <thead>
                        <tr>
                            %colNames = message.pop(0)
                            %for cn in colNames:
                              <th>{{cn}}</th>
                            %end
                        </tr>
